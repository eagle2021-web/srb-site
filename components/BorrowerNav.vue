<template>
  <ul>
    ...
    <li :class="{ 'pleft-cur': $route.fullPath === '/user/borrow' }">
      <span>
    ...
    <li :class="{ 'pleft-cur': $route.fullPath === '/user/repayment' }">
      <span>
        <NuxtLink style="text-align:center;width:115px;" to="/user/repayment">
          还款计划
        </NuxtLink>
      </span>
    </li>
